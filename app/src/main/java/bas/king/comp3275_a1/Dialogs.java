...
//                        Button to exit dialog; activates pnClick
                    ...
                    case 1:
                        ...
                        ** Gives option of closing activity and going to home (main) activity
                        ...
                        popUp.setMessage("Options");
                        popUp.setPositiveButton("Home", new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
...
//                        Closes dialog if no pressed
                        popUp.setNegativeButton("Toast",  new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(getApplicationContext(), "Toast Instead!", Toast.LENGTH_SHORT).show();
                            }// onClick
                        });
...
//        Should pass values to pop up dialog
        //Passes the year, month and day to the Listener event to be outputted to the user
        DatePickerDialog caliDialog = new DatePickerDialog(Dialogs.this,listener,year, month, day );
        caliDialog.show();
    }// datePicker
